...
public class PackageVerifierTest {
    ...
    static final String BDD_BASE_PACKAGE = "bdd." + BASE_PACKAGE;
    ...
    void shouldVerifyThatAllTheControllersAreDefinedInsideControllerPackage() {
        ...
        final Set<Class<?>> controllerClassesInControllerPackage = getTypesAnnotatedWith(
                Controller.class,
    ...
    void shouldVerifyThatAllTheRepositoriesAreDefinedInsideDaoPackage() {
        ...
        final Set<Class<?>> repositoryClassesInDaoPackage = getTypesAnnotatedWith(
                Repository.class,
                BASE_PACKAGE + ".persistence.dao"
        );
    ...
    void shouldVerifyThatAllTheDtosAreDefinedInsideDtoPackage() {
        ...
        final Set<String> dtoClassesInDtoPackage = getAllTypes(
                ".*DTO.class$",
                BASE_PACKAGE + ".persistence.dto"
        );
    ...
    void shouldVerifyThatAllTheEntityBuildersAreDefinedInsideBuilderPackage() {
        final Set<String> allBuilderClasses = getAllTypesWithExclusions(
                ".*Builder.class$",
                ".*DTOBuilder.class$",
                BASE_PACKAGES
        );
        final Set<String> builderClassesInBuilderPackage = getAllTypesWithExclusions(
                ".*Builder.class$", ".*DTOBuilder.class$",
                BASE_PACKAGE + ".persistence.model"
        );
    ...
    void shouldVerifyThatAllTheServicesAreDefinedInsideServicePackage() {
        ...
        final Set<Class<?>> serviceClassesInServicePackage = getTypesAnnotatedWith(
                Service.class,
    ...
    void shouldVerifyThatAllTheEntitiesAreDefinedInsideModelPackage() {
        ...
        final Set<Class<?>> entityClassesInModelPackage = getTypesAnnotatedWith(
                Entity.class,
                BASE_PACKAGE + ".persistence.model"
        );
    ...
    void shouldVerifyThatAllTheConfigurationsAreDefinedInsideSpringPackage() {
        ...
        final Set<Class<?>> configurationClassesInSpringPackage = getTypesAnnotatedWith(
                Configuration.class,
                BASE_PACKAGE + ".spring"
        );
        final Set<Class<?>> configurationClassesInBDDPackage = getTypesAnnotatedWith(
                Configuration.class,
                BDD_BASE_PACKAGE
        );

        final int expectedCount = allConfigurationClasses.size() - configurationClassesInBDDPackage.size();
        assertThat(configurationClassesInSpringPackage.isEmpty(), is(false));
        assertThat(configurationClassesInSpringPackage.size(), is(expectedCount));
    }
    ...
    void shouldVerifyThatAllThePageObjectsAreDefinedInsidePageObjectsPackage() {
        ...
        final Set<Class<? extends FluentPage>> fluentPagesInPageObjectPackage =
                new Reflections(BASE_PACKAGE + ".utils.ui.pageobjects")
                        .getSubTypesOf(FluentPage.class);
    ...
    @Test
    void shouldVerifyThatAllThePageAssertsAreDefinedInsidePageAssertsPackage() {
        final Set<Class<? extends AbstractAssert>> allFluentPages = new Reflections(
                new ConfigurationBuilder().forPackages(BASE_PACKAGES)
        ).getSubTypesOf(AbstractAssert.class);
        final Set<Class<? extends AbstractAssert>> fluentPagesInPageObjectPackage =
                new Reflections(BASE_PACKAGE + ".utils.ui.pageasserts")
                        .getSubTypesOf(AbstractAssert.class);
